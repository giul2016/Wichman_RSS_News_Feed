...
public class MyContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "app.wichman_rss_news.android.example.com.wichman_rss_news_feed.MyContentProvider";
   // static final String URL = "content//" + Provider_Name + "/menuItems";
   // static final Uri CONTENT_URL = Uri.parse(URL);

    // The Java namespace for the Content Provider
    //static final String PROVIDER_NAME = "com.newthinktank.derekbanas.contactprovider.ContactProvider";
